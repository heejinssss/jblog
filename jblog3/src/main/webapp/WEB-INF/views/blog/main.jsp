...
<title>JBlog</title>
<Link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/jblog.css?after">
</head>
<body>
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				<div class="blog-content">
					...
					<p>${fn:replace(postList[postIdx].contents, newline, "<br>") }
				...
				<ul class="blog-list">
					...
					<c:forEach items="${postList }" var="vo" varStatus="status">
						<li><a
							href="${pageContext.request.contextPath}/${blogVo.blogId}/${vo.categoryNo}/${vo.no}?type=${type}">${vo.title }</a>
